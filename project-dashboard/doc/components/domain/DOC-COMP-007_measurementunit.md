...
# DOC-COMP-007: MeasurementUnit

## 1. Overview

**Purpose:** Immutable value object representing a measurement unit for vital signs (e.g., "bpm" for heart rate, "%" for SpO2, "mmHg" for blood pressure). Ensures type-safe unit handling and conversion.

**Responsibilities:**
- Define measurement unit types (RATE, PERCENTAGE, PRESSURE, TEMPERATURE, etc.)
- Provide unit symbols and display names
- Support unit conversion (if applicable)
- Ensure type-safe vital sign measurements

**Layer:** Domain Layer (Value Object)

**Module:** `z-monitor/src/domain/monitoring/` (to be implemented)

**Common Units:**
- Heart Rate: "bpm" (beats per minute)
- SpO2: "%" (percentage)
- Blood Pressure: "mmHg" (millimeters of mercury)
- Temperature: "°C" or "°F" (degrees Celsius/Fahrenheit)
