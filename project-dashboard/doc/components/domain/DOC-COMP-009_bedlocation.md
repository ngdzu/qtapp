...
**Purpose:** Immutable value object representing a bed/room location identifier (e.g., "ICU-4B", "Room 201-Bed 1"). Provides standardized location representation for patient admission.

**Responsibilities:**
- Encapsulate bed/room location identifier
- Provide optional unit/facility information
- Support location equality comparison
- Ensure thread-safe sharing (all members are const)
- Validate location format

**Layer:** Domain Layer (Value Object)

**Module:** `z-monitor/src/domain/admission/BedLocation.h`

**Key Attributes:**
- `location` (const std::string) - Bed/room location identifier
- `unit` (const std::string) - Unit/facility identifier (optional)

**Examples:**
- "ICU-4B" (ICU unit, bed 4B)
- "Room 201-Bed 1" (standard room)
- "ER-Bay 3" (emergency room bay)
