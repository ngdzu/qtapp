...
Describes the design and responsibilities of the database access module in Z Monitor.

## Workflow Steps
1. **Define Module Responsibilities**
   - Database connection, query execution, migration
...
- DatabaseModuleDTO: { name, responsibilities, interfaces }
- DatabaseModuleTestEventDTO: { test_name, status, timestamp }
