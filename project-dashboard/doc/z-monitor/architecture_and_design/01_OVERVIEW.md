...
- **Domain-Driven Design:** The codebase is structured into domain, application, infrastructure, and interface layers (see [29_SYSTEM_COMPONENTS.md](./29_SYSTEM_COMPONENTS.md)).
