...
**Version:** 1.2  
**Status:** ⚠️ LEGACY - Migrated to new documentation structure  
**Last Updated:** 2025-12-01

> **⚠️ LEGACY DOCUMENT NOTICE:**  
> This document has been migrated to the new documentation structure.  
> **New Location:** `../../processes/DOC-PROC-009_schema_management.md`  
> This legacy file is kept for reference only. Please refer to the new documentation for current information.
...
> - **[../../processes/DOC-PROC-009_schema_management.md](../../processes/DOC-PROC-009_schema_management.md)** – NEW: Schema management process documentation ⭐
...
## 8.1. Qt SQL Plugin Deployment Configuration
...
### **CMake Plugin Deployment (z-monitor/src/CMakeLists.txt)**
...
### **Runtime Plugin Path Configuration (main.cpp)**
