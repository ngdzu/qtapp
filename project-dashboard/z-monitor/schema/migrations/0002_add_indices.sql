-- Migration: 0002_add_indices.sql
-- Description: Add performance indices for all tables
-- Date: 2025-01-15
-- 
-- This migration adds all performance indices defined in schema/database.yaml
...
-- ═══════════════════════════════════════════════════════════
-- TELEMETRY METRICS TABLE INDICES
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
-- ADMISSION EVENTS TABLE INDICES
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
-- SECURITY AUDIT LOG TABLE INDICES
-- ═══════════════════════════════════════════════════════════
