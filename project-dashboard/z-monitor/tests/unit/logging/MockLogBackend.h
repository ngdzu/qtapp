...
namespace ZMonitor
{
    namespace Infrastructure
    {
        namespace Logging
        {
             ...
             */
            class MockLogBackend : public zmon::ILogBackend
            {
            public:
                /**
                 * @brief Constructor.
                 ...
                 */
                zmon::Result<void> initialize(const QString &logDir, const QString &logFileName) override;
                 ...
                 */
                void write(const zmon::LogEntry &entry) override;
                 ...
                 */
                QList<zmon::LogEntry> entries() const;
